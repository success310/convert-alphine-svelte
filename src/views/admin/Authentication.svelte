...
<div class="grid grid-cols-1 p-4 space-y-8 lg:gap-8 lg:space-y-0 lg:grid-cols-3">
  ...
  <div class="col-span-2 bg-white rounded-md dark:bg-darker">
    ...
    <div class="flex items-center justify-between p-4 border-b dark:border-primary">
      ...
      <div class="flex items-center space-x-2">
        ...
        <button
          ...
          on:click="{() => {isOn = !isOn; updateBarChart(isOn)}}"
        >
          <div
            class="w-12 h-6 transition rounded-full outline-none bg-primary-100 dark:bg-primary-darker"
          ></div>
          <div
            class="{ isOn ? 'translate-x-6 bg-primary-light dark:bg-primary': 'translate-x-0  bg-white dark:bg-primary-100'} absolute top-0 left-0 inline-flex items-center justify-center w-6 h-6 transition-all duration-200 ease-in-out transform scale-110 rounded-full shadow-sm"
          ></div>
        </button>
      </div>
    </div>
    ...
    <div class="relative p-4 h-72">
      <canvas id="barChart" bind:this={barChart}></canvas>
    </div>
  </div>
...
<div class="grid grid-cols-1 p-4 space-y-8 lg:gap-8 lg:space-y-0 lg:grid-cols-3">
  ...
  <div class="col-span-2 bg-white rounded-md dark:bg-darker">
    ...
    <!-- Chart -->
    <div class="relative p-4 h-72">
      <canvas id="lineChart" bind:this={lineChart}></canvas>
    </div>
  </div>
</div>